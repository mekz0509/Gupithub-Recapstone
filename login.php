...
<!-- Login Account Form -->
    ...
    <div class="login-container">
            ...
            <div class="contForms container-fluid">
                <form action="" method="POST" id="caForms">

                <div class="loginh2">
                  <a href="index.html"><img src="images/login.png" width="170px"></a>
                </div>
                    <div>
                ...
                <!-- Password -->
                    ...
                    <button class="loginbtn type="submit" id="loginbtn">LOGIN</button><br>
                    <p style="text-transform: none; color: rgb(27, 27, 27);">Not a member? <a href="signup.html">Signup</a></p> 
                </form>
            </div>
    </div>
